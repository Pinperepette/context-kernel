...
| `CK_PARK` / `CK_PARK_MAX` / `CK_PARK_KEEP` / `CK_PARK_TTL` | `1` / 512 KB / `80` / 24h | output parking of elided ephemeral results; `recall.py` for targeted recovery |
